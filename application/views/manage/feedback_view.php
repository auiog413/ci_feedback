                                                ...
                                                <div class="portlet-body">
                                                        ...
                                                        <tr role="row">
                                                                <th class="sorting_disabled" role="columnheader" rowspan="1" colspan="1" aria-label="" style="width: 32px;">
                                                                        ...
                                                                        Rendering engine : activate to sort column descending" style="width: 100px;">
                                                                        感觉
                                                                </th><th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="
                                                                        Rendering engine : activate to sort column descending" style="width: 150px;">
                                                                        版本号
                                                                </th><th class="sorting_asc" role="columnheader" tabindex="0" aria-controls="sample_1" rowspan="1" colspan="1" aria-sort="ascending" aria-label="
                                                                        Rendering engine : activate to sort column descending" style="width: 150px;">
                                                                        操作系统
                                                        ...
                                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                                <?php $seqs = 1; foreach ($fb_list->result() as $item):?>
                                                                        ...
                                                                        <tr class="odd" id="fbitem_<?php echo $item->id;?>"><?php $colspan=0;?>
                                                                                ...
                                                                                <?php $colspan++;?><td><?php if($item->vote == 'Like'){echo '喜欢';}elseif($item->vote=='Neutral'){echo '一般';}elseif($item->vote == 'Dislike'){echo '不喜欢';}?></td>
                                                                                <?php $colspan++;?><td><?php echo $item->version;?></td>
                                                                                <?php $colspan++;?><td><?php echo $item->os;?></td>
                                                                                <?php $colspan++;?>
                                                                                <td><?php
                                                                                        $hascontent = '';
